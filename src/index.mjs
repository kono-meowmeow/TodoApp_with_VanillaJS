const onClickAdd = () => {
  ...
  deleteButton.addEventListener("click", () => {
    ...
    const deleteTarget = deleteButton.parentNode.parentNode; // 削除ボタンの親要素(div)の親要素(li)を取得
    document.getElementById("incomplete-list").removeChild(deleteTarget); // ulタグの子要素から削除
  });
